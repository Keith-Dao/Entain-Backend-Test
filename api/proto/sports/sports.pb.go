...
type ListEventsRequest struct {
	...
	Sort   []*ListEventsRequestSort `protobuf:"bytes,2,rep,name=sort,proto3" json:"sort,omitempty"`
}
...
func (x *ListEventsRequest) GetSort() []*ListEventsRequestSort {
	if x != nil {
		return x.Sort
	}
	return nil
...
type ListEventsRequestFilter struct {
	...
	OnlyShowVisible bool     `protobuf:"varint,2,opt,name=only_show_visible,json=onlyShowVisible,proto3" json:"only_show_visible,omitempty"`
}
...
func (x *ListEventsRequestFilter) GetOnlyShowVisible() bool {
	if x != nil {
		return x.OnlyShowVisible
	}
	return false
}

// Sort for listing events.
type ListEventsRequestSort struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *ListEventsRequestSort) Reset() {
	*x = ListEventsRequestSort{}
	if protoimpl.UnsafeEnabled {
...
func (x *ListEventsRequestSort) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ListEventsRequestSort) ProtoMessage() {}

func (x *ListEventsRequestSort) ProtoReflect() protoreflect.Message {
	mi := &file_sports_sports_proto_msgTypes[3]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ListEventsRequestSort.ProtoReflect.Descriptor instead.
func (*ListEventsRequestSort) Descriptor() ([]byte, []int) {
	return file_sports_sports_proto_rawDescGZIP(), []int{3}
}

func (x *ListEventsRequestSort) GetColumn() string {
	if x != nil {
		return x.Column
	}
	return ""
...
func (x *ListEventsRequestSort) GetIsDescending() bool {
	if x != nil {
...
var file_sports_sports_proto_rawDesc = []byte{
	...
	0x61, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x7f, 0x0a, 0x11,
	...
	0x72, 0x74, 0x18, 0x02, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x1d, 0x2e, 0x73, 0x70, 0x6f, 0x72, 0x74,
	0x73, 0x2e, 0x4c, 0x69, 0x73, 0x74, 0x45, 0x76, 0x65, 0x6e, 0x74, 0x73, 0x52, 0x65, 0x71, 0x75,
	0x65, 0x73, 0x74, 0x53, 0x6f, 0x72, 0x74, 0x52, 0x04, 0x73, 0x6f, 0x72, 0x74, 0x22, 0x3b, 0x0a,
	...
	,
	...
	0x69, 0x64, 0x22, 0xdb, 0x01, 0x0a, 0x05, 0x45, 0x76, 0x65, 0x6e, 0x74, 0x12, 0x0e, 0x0a, 0x02,
	...
	0x32, 0xb7, 0x01, 0x0a, 0x06, 0x53, 0x70, 0x6f, 0x72, 0x74, 0x73, 0x12, 0x5f, 0x0a, 0x0a, 0x4c,
	...
	0x2f, 0x6c, 0x69, 0x73, 0x74, 0x2d, 0x65, 0x76, 0x65, 0x6e, 0x74, 0x73, 0x12, 0x4c, 0x0a, 0x08,
	...
	0x22, 0x18, 0x82, 0xd3, 0xe4, 0x93, 0x02, 0x12, 0x12, 0x10, 0x2f, 0x76, 0x31, 0x2f, 0x65, 0x76,
	0x65, 0x6e, 0x74, 0x2f, 0x7b, 0x69, 0x64, 0x3d, 0x2a, 0x7d, 0x42, 0x09, 0x5a, 0x07, 0x2f, 0x73,
...
var file_sports_sports_proto_goTypes = []interface{}{
	...
	(*ListEventsRequestSort)(nil),   // 3: sports.ListEventsRequestSort
...
var file_sports_sports_proto_depIdxs = []int32{
	...
	3, // 1: sports.ListEventsRequest.sort:type_name -> sports.ListEventsRequestSort
	...
	4, // 5: sports.Sports.GetEvent:input_type -> sports.GetEventRequest
	1, // 6: sports.Sports.ListEvents:output_type -> sports.ListEventsResponse
	5, // 7: sports.Sports.GetEvent:output_type -> sports.Event
...
func file_sports_sports_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_sports_sports_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*ListEventsRequestSort); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
